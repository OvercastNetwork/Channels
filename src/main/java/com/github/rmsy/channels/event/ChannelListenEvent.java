...
/**
 * Raised when a user becomes a listener on a channel.
 */
public class ChannelListenEvent extends ChannelsEvent implements Cancellable {
    /**
    ...
    private ChannelListenEvent() {
        this.channel = null;
        this.player = null;
    }

    /**
     * Creates a new ChannelListenEvent.
     *
     * @param channel The channel.
     * @param player  The listener.
     */
    public ChannelListenEvent(@Nonnull final Channel channel, @Nonnull final Player player) {
    ...
    public HandlerList getHandlers() {
        return ChannelListenEvent.handlers;
    }
